      ...
      <main className="flex-1 overflow-hidden flex flex-col">
        ...
        {page === "powerdialler" && (
          <div className="flex-1 overflow-y-auto">
            ...
            {calling && activeLead && (
              <div className="mx-8 mt-6 flex items-center justify-between bg-green-50 border border-green-200 rounded-xl px-5 py-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-sm">
                    <span className="font-semibold">Calling {activeLead.name}</span>
                    <span className="text-gray-500"> · {activeLead.phone}</span>
                  </div>
                </div>
                <button
                  onClick={() => setCalling(false)}
                  className="flex items-center gap-1.5 bg-red-600 hover:bg-red-700 text-white text-xs px-3 py-1.5 rounded-full font-semibold"
                >
            ...
            <table className="w-full text-sm mt-2">
              <thead>
                <tr className="text-left text-xs text-gray-400 uppercase tracking-wide border-b border-gray-100">
                  ...
                  <th className="py-3 font-medium">Status</th>
                  <th className="py-3 pr-8 font-medium text-right">Action</th>
                </tr>
              </thead>
              <tbody>
                {filteredDialQueue.map((lead) => (
                  ...
                  >
                    <td className="px-8 py-3.5 font-medium">{lead.name}</td>
                    <td className="py-3.5 text-gray-600">{lead.email}</td>
                    <td className="py-3.5 text-gray-600">{lead.phone}</td>
                    <td className="py-3.5 text-gray-600">{lead.client}</td>
                    <td className="py-3.5 text-gray-500 max-w-xs truncate" title={lead.notes}>
                      {lead.notes}
                    </td>
                    <td className="py-3.5">
